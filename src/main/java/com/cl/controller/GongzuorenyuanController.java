...
public class GongzuorenyuanController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		GongzuorenyuanEntity u = gongzuorenyuanService.selectOne(new EntityWrapper<GongzuorenyuanEntity>().eq("zhanghao", username));
    ...
    public R register(@RequestBody GongzuorenyuanEntity gongzuorenyuan){
    	...
    	GongzuorenyuanEntity u = gongzuorenyuanService.selectOne(new EntityWrapper<GongzuorenyuanEntity>().eq("zhanghao", gongzuorenyuan.getZhanghao()));
		if(u!=null) {
    ...
    public R info(@PathVariable("id") Long id){
		...
		gongzuorenyuan = gongzuorenyuanService.selectView(new EntityWrapper<GongzuorenyuanEntity>().eq("id", id));
